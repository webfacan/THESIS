...
def get_data_generators():
    ...
    random.sample(SUBJECTS, len(SUBJECTS))
    ...
    x_train, y_train = load_emg_data(DATA_DIR, TRAIN_SUBJECTS, GESTURES, REPS)
    x_val, y_val = load_emg_data(DATA_DIR, VAL_SUBJECTS, GESTURES, REPS)
