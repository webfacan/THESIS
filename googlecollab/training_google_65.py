from models_google_65 import AtzoriNet
import numpy as np
...
from data_loader_google_65 import get_data_generators
...
for subject_id in SUBJECTS:
    ...
    train_generator, val_generator = get_data_generators(subject_id)
